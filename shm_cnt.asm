...
struct shm_cnt *counter;
  pid=fork();
    1014:	e8 22 03 00 00       	call   133b <fork>
  sleep(1);
  ...
  sleep(1);
    1020:	e8 ae 03 00 00       	call   13d3 <sleep>
...
shm_open(1,(char **)&counter);
    ...
    1029:	5e                   	pop    %esi
    102a:	50                   	push   %eax
    102b:	be 14 18 00 00       	mov    $0x1814,%esi
    1030:	6a 01                	push   $0x1
    1032:	e8 ac 03 00 00       	call   13e3 <shm_open>
 
//  printf(1,"%s returned successfully from shm_open with counter %x\n", pid? "Child": "Parent", counter); 
  for(i = 0; i < 10000; i++)
    1037:	83 c4 10             	add    $0x10,%esp
    103a:	b8 1b 18 00 00       	mov    $0x181b,%eax
    103f:	85 ff                	test   %edi,%edi
    1041:	0f 44 f0             	cmove  %eax,%esi
    ...
    1053:	ff 75 e4             	push   -0x1c(%ebp)
    1056:	e8 85 07 00 00       	call   17e0 <uacquire>
     counter->cnt++;
    105b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    105e:	83 40 04 01          	addl   $0x1,0x4(%eax)
     urelease(&(counter->lock));
    1062:	89 04 24             	mov    %eax,(%esp)
    1065:	e8 96 07 00 00       	call   1800 <urelease>
    106a:	69 c3 d5 78 e9 26    	imul   $0x26e978d5,%ebx,%eax
    1070:	83 c4 10             	add    $0x10,%esp
    1073:	c1 c8 03             	ror    $0x3,%eax

//print something because we are curious and to give a chance to switch process
     if(i%1000 == 0)
    1076:	3d 37 89 41 00       	cmp    $0x418937,%eax
    107b:	77 1a                	ja     1097 <main+0x97>
       printf(1,"Counter in %s is %d at address %x\n",pid? "Parent" : "Child", counter->cnt, counter);
    107d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1080:	83 ec 0c             	sub    $0xc,%esp
    1083:	50                   	push   %eax
    1084:	ff 70 04             	push   0x4(%eax)
    1087:	56                   	push   %esi
    1088:	68 54 18 00 00       	push   $0x1854
    108d:	6a 01                	push   $0x1
    108f:	e8 1c 04 00 00       	call   14b0 <printf>
    1094:	83 c4 20             	add    $0x20,%esp
  for(i = 0; i < 10000; i++)
    1097:	83 c3 01             	add    $0x1,%ebx
    109a:	81 fb 10 27 00 00    	cmp    $0x2710,%ebx
    10a0:	75 ae                	jne    1050 <main+0x50>
}
  
  if(pid)
     {
       printf(1,"Counter in parent is %d\n",counter->cnt);
    10a2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    10a5:	8b 40 04             	mov    0x4(%eax),%eax
  if(pid)
    10a8:	85 ff                	test   %edi,%edi
    10aa:	74 25                	je     10d1 <main+0xd1>
       printf(1,"Counter in parent is %d\n",counter->cnt);
    10ac:	51                   	push   %ecx
    10ad:	50                   	push   %eax
    10ae:	68 21 18 00 00       	push   $0x1821
    10b3:	6a 01                	push   $0x1
    10b5:	e8 f6 03 00 00       	call   14b0 <printf>
    wait();
    10ba:	e8 8c 02 00 00       	call   134b <wait>
...
//shm_close: first process will just detach, next one will free up the shm_table entry (but for now not the page)
   shm_close(1);
    ...
    10c5:	6a 01                	push   $0x1
    10c7:	e8 1f 03 00 00       	call   13eb <shm_close>
   exit();
    10cc:	e8 72 02 00 00       	call   1343 <exit>
    printf(1,"Counter in child is %d\n\n",counter->cnt);
    10d1:	52                   	push   %edx
    10d2:	50                   	push   %eax
    10d3:	68 3a 18 00 00       	push   $0x183a
    10d8:	6a 01                	push   $0x1
    10da:	e8 d1 03 00 00       	call   14b0 <printf>
    10df:	83 c4 10             	add    $0x10,%esp
    10e2:	eb de                	jmp    10c2 <main+0xc2>
    ...
    140c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1439:	0f b6 92 d8 18 00 00 	movzbl 0x18d8(%edx),%edx
    ...
    14b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1529:	ff 24 85 80 18 00 00 	jmp    *0x1880(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1637:	90                   	nop
          s = "(null)";
    1638:	ba 77 18 00 00       	mov    $0x1877,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1651:	a1 cc 1b 00 00       	mov    0x1bcc,%eax
{
  ...
  freep = p;
    ...
    1691:	5b                   	pop    %ebx
  freep = p;
    1692:	89 15 cc 1b 00 00    	mov    %edx,0x1bcc
}
    1698:	5e                   	pop    %esi
    1699:	5f                   	pop    %edi
    169a:	5d                   	pop    %ebp
  ...
  freep = p;
    16cc:	89 15 cc 1b 00 00    	mov    %edx,0x1bcc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16ec:	8b 3d cc 1b 00 00    	mov    0x1bcc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1731:	8b 3d cc 1b 00 00    	mov    0x1bcc,%edi
  ...
  return freep;
    175f:	8b 15 cc 1b 00 00    	mov    0x1bcc,%edx
    ...
    178c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    178f:	89 15 cc 1b 00 00    	mov    %edx,0x1bcc
}
    ...
    179f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    17a0:	c7 05 cc 1b 00 00 d0 	movl   $0x1bd0,0x1bcc
    17a7:	1b 00 00 
    base.s.size = 0;
    17aa:	bf d0 1b 00 00       	mov    $0x1bd0,%edi
    base.s.ptr = freep = prevp = &base;
    17af:	c7 05 d0 1b 00 00 d0 	movl   $0x1bd0,0x1bd0
    17b6:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    17b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    17bb:	c7 05 d4 1b 00 00 00 	movl   $0x0,0x1bd4
    17c2:	00 00 00 
    if(p->s.size >= nunits){
