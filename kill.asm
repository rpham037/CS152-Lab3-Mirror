...
main(int argc, char **argv)
{
  ...
  exit();
    ...
    104a:	50                   	push   %eax
    104b:	50                   	push   %eax
    104c:	68 84 17 00 00       	push   $0x1784
    1051:	6a 02                	push   $0x2
    1053:	e8 c8 03 00 00       	call   1420 <printf>
    exit();
    ...
    137c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    13a9:	0f b6 92 f8 17 00 00 	movzbl 0x17f8(%edx),%edx
    ...
    1429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1499:	ff 24 85 a0 17 00 00 	jmp    *0x17a0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    15a7:	90                   	nop
          s = "(null)";
    15a8:	ba 98 17 00 00       	mov    $0x1798,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15c1:	a1 f0 1a 00 00       	mov    0x1af0,%eax
{
  ...
  freep = p;
    ...
    1601:	5b                   	pop    %ebx
  freep = p;
    1602:	89 15 f0 1a 00 00    	mov    %edx,0x1af0
}
    1608:	5e                   	pop    %esi
    1609:	5f                   	pop    %edi
    160a:	5d                   	pop    %ebp
  ...
  freep = p;
    163c:	89 15 f0 1a 00 00    	mov    %edx,0x1af0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    165c:	8b 3d f0 1a 00 00    	mov    0x1af0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16a1:	8b 3d f0 1a 00 00    	mov    0x1af0,%edi
  ...
  return freep;
    16cf:	8b 15 f0 1a 00 00    	mov    0x1af0,%edx
    ...
    16fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    16ff:	89 15 f0 1a 00 00    	mov    %edx,0x1af0
}
    ...
    170f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1710:	c7 05 f0 1a 00 00 f4 	movl   $0x1af4,0x1af0
    1717:	1a 00 00 
    base.s.size = 0;
    171a:	bf f4 1a 00 00       	mov    $0x1af4,%edi
    base.s.ptr = freep = prevp = &base;
    171f:	c7 05 f4 1a 00 00 f4 	movl   $0x1af4,0x1af4
    1726:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    172b:	c7 05 f8 1a 00 00 00 	movl   $0x0,0x1af8
    1732:	00 00 00 
    if(p->s.size >= nunits){
