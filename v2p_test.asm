...
int main() {
    ...
    1017:	e8 1f 03 00 00       	call   133b <sbrk>
    va = (uint)mem;

    // Write to memory to ensure the page is allocated
    *mem = 'A';
    101c:	c6 00 41             	movb   $0x41,(%eax)
    char *mem = sbrk(4096);  // Allocate one page (4 KB)
    101f:	89 c3                	mov    %eax,%ebx

    // Test v2p
    if (v2p(va, &pa) < 0) {
    1021:	8d 45 f4             	lea    -0xc(%ebp),%eax
    1024:	5a                   	pop    %edx
    1025:	59                   	pop    %ecx
    1026:	50                   	push   %eax
    1027:	53                   	push   %ebx
    1028:	e8 36 03 00 00       	call   1363 <v2p>
    102d:	83 c4 10             	add    $0x10,%esp
    1030:	85 c0                	test   %eax,%eax
    1032:	78 15                	js     1049 <main+0x49>
        printf(1, "v2p failed for virtual address: 0x%x\n", va);
        exit();
    }

    printf(1, "Virtual Address: 0x%x -> Physical Address: 0x%x\n", va, pa);
    1034:	ff 75 f4             	push   -0xc(%ebp)
    1037:	53                   	push   %ebx
    1038:	68 ac 17 00 00       	push   $0x17ac
    103d:	6a 01                	push   $0x1
    103f:	e8 dc 03 00 00       	call   1420 <printf>
    exit();
    1044:	e8 6a 02 00 00       	call   12b3 <exit>
        printf(1, "v2p failed for virtual address: 0x%x\n", va);
    1049:	50                   	push   %eax
    104a:	53                   	push   %ebx
    104b:	68 84 17 00 00       	push   $0x1784
    1050:	6a 01                	push   $0x1
    1052:	e8 c9 03 00 00       	call   1420 <printf>
        exit();
    1057:	e8 57 02 00 00       	call   12b3 <exit>
    ...
    137c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    13a9:	0f b6 92 3c 18 00 00 	movzbl 0x183c(%edx),%edx
    ...
    1429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1499:	ff 24 85 e4 17 00 00 	jmp    *0x17e4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    15a7:	90                   	nop
          s = "(null)";
    15a8:	ba dd 17 00 00       	mov    $0x17dd,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15c1:	a1 28 1b 00 00       	mov    0x1b28,%eax
{
  ...
  freep = p;
    ...
    1601:	5b                   	pop    %ebx
  freep = p;
    1602:	89 15 28 1b 00 00    	mov    %edx,0x1b28
}
    1608:	5e                   	pop    %esi
    1609:	5f                   	pop    %edi
    160a:	5d                   	pop    %ebp
  ...
  freep = p;
    163c:	89 15 28 1b 00 00    	mov    %edx,0x1b28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    165c:	8b 3d 28 1b 00 00    	mov    0x1b28,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16a1:	8b 3d 28 1b 00 00    	mov    0x1b28,%edi
  ...
  return freep;
    16cf:	8b 15 28 1b 00 00    	mov    0x1b28,%edx
    ...
    16fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    16ff:	89 15 28 1b 00 00    	mov    %edx,0x1b28
}
    ...
    170f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1710:	c7 05 28 1b 00 00 2c 	movl   $0x1b2c,0x1b28
    1717:	1b 00 00 
    base.s.size = 0;
    171a:	bf 2c 1b 00 00       	mov    $0x1b2c,%edi
    base.s.ptr = freep = prevp = &base;
    171f:	c7 05 2c 1b 00 00 2c 	movl   $0x1b2c,0x1b2c
    1726:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    172b:	c7 05 30 1b 00 00 00 	movl   $0x0,0x1b30
    1732:	00 00 00 
    if(p->s.size >= nunits){
